    ...
    <form action="{{url('admin/article/')}}/{{$item['art_id']}}" method="post">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <input value="{{$item->art_title}}" type="text" class="lg" name="art_title"><span style="color: red;">* <?php  echo session('msg');?></span>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input value="{{$item->art_editor}}" type="text" class="sm" name="art_editor">
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <input  value="{{$item->art_tag}}" type="text" class="md" name="art_tag"><span style="color: red;">* <?php  echo session('msg');?></span>
                </td>
            </tr>
            ...
            <tr>
                <th>文章缩略图：</th>
                <td>
                    <input type="text" name="art_thumb" size="50" id="art_thumb" value="{{$item->art_thumb}}">
            ...
            <tr>
                <th></th>
                <td>
                    <img id="uploadImg" src="/graduateDesign/{{$item->art_thumb}}" alt="" style="max-width: 350px; max-height: 120px;">
                </td>
            </tr>
            <tr>
                <th>文章内容：</th>
                <td>
                    ...
                    <script id="editor" name="art_content" type="text/plain" style="width:768px;height:300px;">
                        {!! $item->art_content !!}
                    </script>
                    <script type="text/javascript">
