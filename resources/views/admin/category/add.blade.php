...
<body>
    ...
    <div class="crumb_warp">
        <i class="glyphicon glyphicon-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; 添加分类
    </div>
    <!--面包屑导航 结束-->
            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input type="text"  name="cate_name" style="width: 200px">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text"  name="cate_url" style="width: 300px">
                        </td>
                    </tr>
                    <tr>
                        <th></th>
