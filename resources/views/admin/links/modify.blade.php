...
<body>
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/index')}}">首页</a> &raquo; 新增链接
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <form action="{{url('admin/links/').'/'.$current->link_id}}" method="post">
            ...
            <table class="add_tab">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <input value="{{$current->link_name}}" type="text" class="sm" name="link_name"><span style="color: red;">* <?php  echo session('msg');?></span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>链接描述：</th>
                        <td>
                            <input value="{{$current->link_description}}" type="text" class="lg" name="link_name">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <th>URL：</th>
                        <td>
                            <input type="text" name="link_url" value="{{$current->link_url}}">
                        </td>
                    </tr>
                    <tr>
                        <th><i class="require">*</i>链接排序：</th>
                        <td>
                            <input type="text" class="sm" name="link_order" value="{{$current->link_order}}">
